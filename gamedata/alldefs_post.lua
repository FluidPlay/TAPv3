...
-- So, if we want to do post processing and include all the unit+weapon defs, and have the ability to bake these
-- changes into files, we must do it after both have been loaded;
...
-- [No longer, that's done with unitdefs_post_save] unitdefs_post.lua writes the corresponding unitDefs to customparams (if wanted)
