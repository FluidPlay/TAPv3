...
local damageMultipliers = {
    ...
    bullet  = { robot = 1.1, vehicle = 0.2, air = 0.4, ship = 0.4, armorbot = 0.4, armorveh = 0.3, armorair = 1.5, armorship = 0.25,
                structure = 0.8, defense = 0.33, armordefense = 0.5, commander = 0.20, shield = 1, superunit = 0.6, ore = 0, guardian = 0.2, },
    ...
    photon = { 	robot = 0.9, vehicle = 0.6, air = 3, ship = 2, armorbot = 0.75, armorveh = 0.25, armorair = 2, armorship = 0.25,
                structure = 1.2, defense = 1.6, armordefense = 1.2, commander = 0.25, shield = 1, superunit = 1, ore = 0, guardian = 0.2, },
    ...
    thermo = { 	robot = 1.2, vehicle = 0.5, air = 1.25, ship = 1, armorbot = 1.1, armorveh = 1.1, armorair = 1, armorship = 1.25,
                structure = 0.5, defense = 0.3, armordefense = 0.4, commander = 0.3, shield = 0.02, superunit = 0.7, ore = 0, guardian = 1.1, },
    ...
    emp = { robot = 1, vehicle = 1.6, air = 1, ship = 1.75, armorbot = 3, armorveh = 4.5, armorair = 1, armorship = 4,
            structure = 0.75, defense = 0.75, armordefense = 1.2, commander = 0.1, shield = 1, superunit = 0.33, ore = 0, guardian = 0, },
    ...
    omni = { 	robot = 1, vehicle = 0.65, air = 1.5, ship = 1.25, armorbot = 1.1, armorveh = 2, armorair = 2, armorship = 2.5,
                structure = 0.5, defense = 0.75, armordefense = 1.0, commander = 0.75, shield = 1, superunit = 1.5, ore = 0, guardian = 0.7, }, --commander 0.4

	explosion = { 	robot = 1.2,  vehicle = 0.55, air = 1, ship = 3, armorbot = 1.1, armorveh = 0.7, armorair = 0.5, armorship = 3,
					structure = 1.25, defense = 0.55, armordefense = 0.25, commander = 0.18, shield = 1, superunit = 2, ore = 0.5, guardian = 0.3, },
