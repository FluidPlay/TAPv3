...
function widget:GetInfo()
  return {
    name      = "Commander Name Tags - Obsolete", --used bitmap Fonthandler
...
local overheadFont	= "LuaUI/Fonts/GeogrotesqueCompMedium.otf" --DefaultFontPath --"LuaUI/Fonts/FreeSansBold_16"
local stickyFont	= "LuaUI/Fonts/GeogrotesqueCompMedium.otf" --DefaultFontPath -- "LuaUI/Fonts/Skrawl_40"
