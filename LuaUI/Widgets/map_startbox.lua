...
local font = gl.LoadFont("LuaUI/Fonts/GeogrotesqueCompMedium.otf", 85, 10, 10)  --FreeSansBold.otf, 55
local shadowFont = gl.LoadFont("LuaUI/Fonts/GeogrotesqueCompMedium.otf", 85, 38, 1.6)
