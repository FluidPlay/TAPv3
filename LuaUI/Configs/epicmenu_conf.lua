local confdata = {}
confdata.title = 'Z.K.'
confdata.title_image = LUAUI_DIRNAME .. 'Images/taplogo.png'
confdata.default_source_file = 'tap_keys.lua' --the file in ZIP archive where default key is stored.
confdata.mission_keybinds_file = 'tap_keys.lua' --the filename to be used for Mission mod. set this to NIL if want to use mission's name as filename.
-- confdata.regular_keybind_file = LUAUI_DIRNAME .. 'Configs/tap_keys.lua' --for Multiplayer this is automatically set according to modName in epicmenu.lua
...
confdata.subMenuIcons = {
	...
	['Settings/Interface/Retreat Zones']            = imgPath..'settings/retreat_zone.png', --'commands/Bold/retreat.png',
	['Settings/Interface/Reclaim Highlight']        = imgPath..'settings/reclaim_highlight.png',
	['Settings/Interface/Spectating']               = imgPath..'settings/spectator.png',
	['Settings/Interface/Building Placement']       = imgPath..'factory.png',
	['Settings/Interface/Team Colors']              = imgPath..'settings/colors.png',
	['Settings/Interface/Common Team Colors']       = imgPath..'settings/colors.png',
	...
	['Settings/Interface/Economy Overlay']          = imgPath..'settings/resources.png',
	...
	['Settings/HUD Panels/Pause Screen']            = imgPath..'settings/pause.png',
	['Settings/HUD Panels/Replay Controls']         = imgPath..'settings/replay_controls.png',
	['Settings/HUD Panels/Unit Stats Help Window']  = imgPath..'settings/random.png',
	['Settings/HUD Panels/Player List']             = imgPath..'settings/player_list.png',
	['Settings/HUD Panels/Extras/Docking']          = imgPath..'settings/docking.png',
	['Settings/HUD Panels/Selected Units Panel']    = imgPath..'settings/selected_units.png',
	['Settings/HUD Panels/Command Panel']           = imgPath..'settings/command.png',
	['Settings/HUD Panels/Quick Selection Bar']     = imgPath..'settings/selection_bar.png',
	['Settings/HUD Panels/Stats Graph']             = imgPath..'settings/graphs.png',
	['Settings/HUD Panels/Global Commands']         = imgPath..'settings/global.png',
	['Settings/HUD Panels/Spectator Panels']        = imgPath..'settings/spectator.png',
	['Settings/HUD Panels/Extras']                  = imgPath..'settings/extras.png',
}
