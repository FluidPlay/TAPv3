...
local unitlistNames = {
	armcom = { mark_each_appearance = true, show_owner = true, },
	armcom1 = { mark_each_appearance = true, show_owner = true, },
	armcom2 = { mark_each_appearance = true, show_owner = true, },
	armcom3 = { mark_each_appearance = true, show_owner = true, },
	armcom4 = { mark_each_appearance = true, show_owner = true, },
	corcom = { mark_each_appearance = true, show_owner = true, },
	corcom1 = { mark_each_appearance = true, show_owner = true, },
	corcom2 = { mark_each_appearance = true, show_owner = true, },
	corcom3 = { mark_each_appearance = true, show_owner = true, },
	corcom4 = { mark_each_appearance = true, show_owner = true, },
